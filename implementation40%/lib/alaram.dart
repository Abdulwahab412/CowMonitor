...
class _alaramState extends State {
  ...
  Future _showNotification() async {
    var androidDetails = new AndroidNotificationDetails(
        "Channel ID", "Abdul Wahab", "Here We Go",
    ...
    var scheduledTime;
    if (_selectedParam == "Months") {
      scheduledTime = DateTime.now().add(Duration(hours: val));
    } else if (_selectedParam == "Days") {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Set Timer For Notification '),
